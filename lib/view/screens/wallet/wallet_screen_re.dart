...
class WalletScreenRe extends StatefulWidget {
  final bool fromWallet;
  const WalletScreenRe({Key? key, required this.fromWallet}) : super(key: key);

  @override
  State<WalletScreenRe> createState() => _WalletScreenReState();
}

class _WalletScreenReState extends State<WalletScreenRe> {
