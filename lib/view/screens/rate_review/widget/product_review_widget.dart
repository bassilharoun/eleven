                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Column(
                                  children: [
                                    !reviewProvider.loadingList[index] ? CustomButton(
                                      btnTxt: getTranslated(reviewProvider.submitList[index] ? 'submitted' : 'submit', context),
                                      backgroundColor: reviewProvider.submitList[index] ? Theme.of(context).hintColor.withOpacity(0.7) : Theme.of(context).primaryColor,
                                      onTap: () {
                                        if(!reviewProvider.submitList[index]) {
